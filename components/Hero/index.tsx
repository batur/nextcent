...
const Home: React.FC = () => {
  return (
    <div className='container mx-auto flex w-full grow flex-row items-center justify-around gap-[104px] py-24'>
      <div className='flex flex-col items-start gap-8'>
        <div className='flex w-full flex-col items-start gap-4 pt-1'>
          <h1 className='text-nowrap text-[64px] font-semibold leading-[76px]' dangerouslySetInnerHTML={{ __html: HEADLINE }} />
          <p>Where to grow your business as a photographer: site or social media?</p>
        </div>
        <Link href='#'>
          <Button className='rounded-sm py-[26px]'>
            <span className='px-5 font-medium leading-6'>Register</span>
          </Button>
        </Link>
      </div>
